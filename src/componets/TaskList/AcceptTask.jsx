...
const AcceptTask = ({employeeData}) => {
  ...
  return (
    <div className='h-full w-[300px] bg-yellow-400 text-zinc-50 p-5 shrink-0 rounded-xl flex flex-col text-left'>
    ...
    {/* <button className='px-2 py-1 bg-zinc-200 text-base text-red-500 rounded-md '>Accept</button> */}
    <button className='px-2 py-1 bg-green-500 text-base text-zinc-950 rounded-md '>Pending</button>    
    </div>
</div>
  )
}
